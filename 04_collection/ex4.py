...
print(tuple(zip(subjects, scores, strict=True)))
...
# List Comprenhension vs Generaotr 표현식
...
# 두 점의 x, y, z축 좌표값끼리 더한 튜플을 만들기 -> (11, 22, 33)
p1 = (1, 2, 3)
p2 = (10, 20, 30)
...
print(sum(stock[1] * stock[2] for stock in stocks))    
print(sum(price * qty for _, price, qty in stocks)) # 변수 하나에다 누적
print(sum([price * qty for _, price, qty in stocks])) # 리스트 만든 후 누적
...
print(sum(price * qty for _, price, qty in zip(*stocks)))